...
import edu.ncsu.csc.itrust.server.FoodDiarySuggestionUpdateServlet;

public class FoodDiarySuggestionUpdateServletTest {
	...
	public void testDoPostHttpServletRequestHttpServletResponse() throws IOException, ServletException {
		...
		when(request.getParameter("newTest")).thenReturn("update");
	...
	private class Delegator extends FoodDiarySuggestionUpdateServlet{
