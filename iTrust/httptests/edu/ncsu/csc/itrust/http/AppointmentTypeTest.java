...
public class AppointmentTypeTest extends iTrustHTTPTest {
	...
	public void testPatientViewUpcomingAppointments() throws Exception {
		...
		Timestamp time1 = new Timestamp(c.getTimeInMillis()+(14*24*60*60*1000));
		
		String dt1 = dateFormat.format(new Date(time1.getTime()));
//		System.out.println(wr.getTables()[0].getRows()[1].getText());
//		System.out.println(dt1+" 10:30 AM");
	...
	public void testHcpViewUpcomingAppointments() throws Exception {
		...
		//Check Table
		//Row 1
		Timestamp time1 = new Timestamp(c.getTimeInMillis()+(7*24*60*60*1000));
		String dt1 = dateFormat.format(new Date(time1.getTime()));
		...
		//Row 3
		Timestamp time2 = new Timestamp(c.getTimeInMillis()+(10*24*60*60*1000));
		...
		//Row 4
		Timestamp time3 = new Timestamp(c.getTimeInMillis()+(14*24*60*60*1000));
