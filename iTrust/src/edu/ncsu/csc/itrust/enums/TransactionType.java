...
public enum TransactionType {
	...
	/**PATIENT_CREATES_FOOD_DIARY**/
	PATIENT_CREATE_FDIARY(6800, "Created a Food Diary Entry", "created a food diary entry", true),
	/**PATIENT_VIEWS_FOOD_DIARY**/
	VIEW_FDIARY(6801, "View Food Diary","viewed food diary", true),
	/**HCP_VIEW_FDIARY**/
	HCP_VIEW_FDIARY(6900, "Patient's Food Diary Viewed by HCP", "viewed your food diaries", true),
	...
	/**PATIENT_ADD_LABEL**/
	PATIENT_ADD_LABEL(7301, "Created a New label", "Created a New Label", true),
	/**PATIENT_GET_LABEL**/
	PATIENT_GET_LABEL(7302, "Retrieved a label", "Retrieved a label", true),
	...
	/**HCP_EDIT_SUGGESTION**/
	HCP_EDIT_SUGGESTION(7502, "Nutritionist edited suggestion in Food Diary", "edited suggestion in food diary", true),
	...
	/**PATIENT_ADD_WEIGHT_LOG**/
	PATIENT_ADD_WEIGHT_LOG(7600, "Patient added entry to weight log", "added weight log entry", true),
	/**PATIENT_VIEW_WEIGHT_LOG**/
	PATIENT_VIEW_WEIGHT_LOG(7601, "Patient retrieved list of weight logs", "viewed weight log entries", true),
	/**HCP_VIEW_WEIGHT_LOG**/
	HCP_VIEW_WEIGHT_LOG(7602, "HCP retrieved list of patient's weight logs", "viewed weight log entries", true)
	;
	/**
